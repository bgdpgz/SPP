...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input_path', default='E:/Desktop/gait recognition/OpenGait-master/datasets/CASIA-B',
                        type=str, help='Root path of raw dataset.')
    parser.add_argument('-o', '--output_path',
                        default='E:/Desktop/gait recognition/OpenGait-master/datasets/CASIA-B-pkl', type=str,
                        help='Output path of pickled dataset.')
    parser.add_argument('-l', '--log_file',
                        default='E:/Desktop/gait recognition/OpenGait-master/datasets/pretreatment.log', type=str,
